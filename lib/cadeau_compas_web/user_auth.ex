defmodule CadeauCompasWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_cadeau_compas_web_user_remember_me"
  ...
  the current_user:
      ...
      defmodule CadeauCompasWeb.PageLive do
        use CadeauCompasWeb, :live_view

        on_mount {CadeauCompasWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{CadeauCompasWeb.UserAuth, :ensure_authenticated}] do
