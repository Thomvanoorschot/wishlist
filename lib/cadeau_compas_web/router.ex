defmodule CadeauCompasWeb.Router do
  use CadeauCompasWeb, :router

  import CadeauCompasWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CadeauCompasWeb.Layouts, :root}
  ...
  if Application.compile_env(:cadeau_compas, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CadeauCompasWeb.Telemetry
