(() => {
  ...
  var JS = {
    ...
    exec_toggle_class(e, eventType, phxEvent, view, sourceEl, el, { to, names, transition, time: time2, blocking }) {
    ...
    show(eventType, view, el, display, transition, time2, blocking) {
      if (!this.isVisible(el)) {
        this.toggle(eventType, view, el, display, transition, null, time2, blocking);
      }
    },
    hide(eventType, view, el, display, transition, time2, blocking) {
      if (this.isVisible(el)) {
        this.toggle(eventType, view, el, display, null, transition, time2, blocking);
      }
    },
    ...
    toggleClasses(el, classes, transition, time2, view, blocking) {
      window.requestAnimationFrame(() => {
        ...
        this.addOrRemoveClasses(el, newAdds, newRemoves, transition, time2, view, blocking);
      });
    },
...
`);
  ...
  Hooks2.LiveToast = createLiveToastHook();
